...
const ParametrixView = () => {
  ...
  <div style={{ display: "flex", gap: "10px" }}>
    ...
    <button
      ...
      onMouseEnter={(e) => {
        e.target.style.backgroundColor = "white"; // Hover background
        e.target.style.color = "#996633"; // Brown text color on hover
      ...
      onMouseDown={(e) => {
        e.target.style.transform = "scale(0.95)"; // Scale down slightly on click
      }}
      onMouseUp={(e) => {
        e.target.style.transform = "scale(1.1)"; // Revert to hover scale
      }}
      onClick={() => alert("STL Button Clicked!")} // Replace with STL functionality
    >
      STL
    </button>
    ...
    <button
      ...
      onMouseEnter={(e) => {
        e.target.style.backgroundColor = "#f4e2cc"; // Hover background
        e.target.style.color = "#996633"; // Brown text color on hover
        e.target.style.transform = "scale(1.1)"; // Scale up on hover
      }}
      onMouseLeave={(e) => {
        e.target.style.backgroundColor = "transparent"; // Revert background
        e.target.style.color = "#f4e2cc"; // Revert text color
        e.target.style.transform = "scale(1)"; // Revert scale
      }}
